  ...
  <div>
    ...
    <!-- <a href=""  > -->
      <div class="box">
        ...
        <div class="linethree">
          <span>{{ item.linethreespan1 }}</span>
          <span>{{ item.linethreespan2 }}</span>
          <span>{{ item.linethreespan3 }}</span>
          <span>{{ item.linethreespan4 }}</span>
        </div>
        <div class="linefour">
          <div class="left">
            <img :src="item.linefourimg" alt="">
            <div class="name">
              <span>{{ item.linefourspan1 }}</span>
              <span>{{ item.linefourspan2 }}</span>
            </div>
          </div>
          <div class="right">
      ...
      list :[
        {
          "catdlink": "/jobdetails",
          "lineonespan1": "UI设计师",
          "lineonespan2": "8000-12000元",
          "linetwospan": "广州小凯有限公司",
          "linethreespan1": "1-3年",
          "linethreespan2": "本科",
          "linethreespan3": "视觉设计",
          "linethreespan4": "全职",
        ...
        },
        {
          "catdlink": "/jobdetails",
          "lineonespan1": "运维工程师",
          "lineonespan2": "9000-15000元",
          "linetwospan": "上海星辰互动",
          "linethreespan1": "1-3年",
          "linethreespan2": "大专",
          "linethreespan3": "Linux",
          "linethreespan4": "全职",
          "linefourimg": "/src/assets/avatar.jpg",
        ...
        },
        {
          "catdlink": "/jobdetails",
          "lineonespan1": "数据分析师",
          "lineonespan2": "10000-16000元",
          "linetwospan": "杭州云帆数据",
          "linethreespan1": "3-5年",
          "linethreespan2": "本科",
          "linethreespan3": "Python",
          "linethreespan4": "全职",
          "linefourimg": "/src/assets/avatar.jpg",
        ...
        },
        {
          "catdlink": "/jobdetails",
          "lineonespan1": "测试工程师",
          "lineonespan2": "8000-13000元",
          "linetwospan": "武汉智慧教育",
          "linethreespan1": "1-3年",
          "linethreespan2": "大专",
          "linethreespan3": "自动化测试",
          "linethreespan4": "全职",
          "linefourimg": "/src/assets/avatar.jpg",
        ...
        {
          "catdlink": "/jobdetails",
          "lineonespan1": "网络安全工程师",
          "lineonespan2": "15000-25000元",
          "linetwospan": "西安绿能科技",
          "linethreespan1": "3-5年",
          "linethreespan2": "本科",
          "linethreespan3": "渗透测试",
        ...
        },
        {
          "catdlink": "/jobdetails",
          "lineonespan1": "SEO优化师",
          "lineonespan2": "8000-15000元",
          "linetwospan": "南京视觉艺术",
          "linethreespan1": "3-5年",
          "linethreespan2": "本科",
          "linethreespan3": "搜索引擎优化",
          "linethreespan4": "全职",
          "linefourimg": "/src/assets/avatar.jpg",
        ...
        },
        {
          "catdlink": "/jobdetails",
          "lineonespan1": "运维工程师",
          "lineonespan2": "8000-14000元",
          "linetwospan": "上海腾跃网络",
          "linethreespan1": "1-3年",
          "linethreespan2": "大专",
          "linethreespan3": "Docker",
          "linethreespan4": "全职",
          "linefourimg": "/src/assets/avatar.jpg",
